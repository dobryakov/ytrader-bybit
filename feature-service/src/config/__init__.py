...
class Config(BaseSettings):
    ...
    feature_service_raw_data_path: str = Field(default="/data/feature-service/raw", env="FEATURE_SERVICE_RAW_DATA_PATH", description="Raw data storage path")
    feature_service_dataset_storage_path: str = Field(default="/data/feature-service/datasets", env="FEATURE_SERVICE_DATASET_STORAGE_PATH", description="Dataset storage path")
