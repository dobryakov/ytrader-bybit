...
def configure_logging() -> None:
    ...
    if settings.order_manager_log_level == "DEBUG":
    ...
    logging.basicConfig(
        format="%(message)s",
        stream=sys.stdout,
        level=getattr(logging, settings.order_manager_log_level),
    )
...
def bind_context(**kwargs: Any) -> None:
    ...
    Args:
        **kwargs: Context variables to bind (e.g., signal_id, order_id, asset)
    """
