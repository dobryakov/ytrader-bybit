# Микросервис обучения и принятия торговых решений (Model Training Service)
...
- Подписывается на очередь RabbitMQ с обогащёнными событиями исполнения ордеров от микросервиса ордеров.
...
- Генерирует высокоуровневые торговые сигналы на основе модели и публикует их в очередь RabbitMQ для микросервиса ордеров.
