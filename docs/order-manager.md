...
- Микросервис ордеров (order manager) управляет ордерами bybit и поддерживает актуальную информацию об их состоянии и исполнении.
...
- Поддерживает подписку на очереди об исполнении ордеров от bybit через ws-gateway.
