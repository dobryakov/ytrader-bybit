...
class DatabaseConnection:
    ...
    async def fetch(cls, query: str, *args) -> list:
        ...
        try:
            ...
            logger.error("database_fetch_failed", query=query[:200], error=str(e))
    ...
    async def fetchrow(cls, query: str, *args) -> Optional[asyncpg.Record]:
        ...
        try:
            ...
            logger.error("database_fetchrow_failed", query=query[:200], error=str(e))
    ...
    async def fetchval(cls, query: str, *args) -> Optional[Any]:
        ...
        try:
            ...
            logger.error("database_fetchval_failed", query=query[:200], error=str(e))
            raise DatabaseError(f"Database fetchval failed: {e}") from e
