...
class WebSocketPositionEvent:
    ...
    def from_message(cls, payload: Dict[str, Any]) -> "WebSocketPositionEvent":
        ...
        return cls(
            ...
            avg_price=to_decimal(data.get("avgPrice") or data.get("avg_price") or data.get("entryPrice")),
            unrealized_pnl=to_decimal(data.get("unrealisedPnl") or data.get("unrealised_pnl")),
            realized_pnl=to_decimal(data.get("realisedPnl") or data.get("realised_pnl")),
            mark_price=to_decimal(data.get("markPrice") or data.get("mark_price")),
            trace_id=trace_id,
