...
- **Phase 3 (User Story 1)**: 49 tasks (23 tests + 26 implementation, added T285-T287 for new price features: volatility for N candles, returns for N candles, volume z-score, added T288-T290 for unit tests for new price features)
...
- **Unit Tests**: 52 tasks (added 4 Statistics API unit tests: T220-T223, added 3 price feature unit tests: T288-T290)
